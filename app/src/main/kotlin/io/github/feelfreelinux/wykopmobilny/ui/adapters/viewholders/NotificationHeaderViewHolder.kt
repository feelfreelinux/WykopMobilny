...
class NotificationHeaderViewHolder(override val containerView: View, val navigatorApi: NewNavigatorApi, var collapseListener : (Boolean, String) -> Unit) : androidx.recyclerview.widget.RecyclerView.ViewHolder(containerView), LayoutContainer {
