...
class RepositoryModule {
    ...
    ): TagApi = TagRepository(retrofit, userTokenRefresher, blacklistPreferences, owmContentFilter)
    ...
    @Provides
    fun provideAddLinkApi(
        retrofit: Retrofit,
        userTokenRefresher: UserTokenRefresher,
        owmContentFilter: OWMContentFilter
    ): AddlinkApi = AddLinkRepository(retrofit, userTokenRefresher, owmContentFilter)
