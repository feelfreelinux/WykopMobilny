...
public class SwipeBackLayout extends FrameLayout {
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        if (mContentView != null) {
            if (!flinged) {
                mContentView.layout(mContentLeft + systemButtonSize, mContentTop,
                        mContentLeft + systemButtonSize + mContentView.getMeasuredWidth(),
    ...
    public void attachToActivity(Activity activity) {
        mActivity = activity;
        systemButtonSize = getSoftbuttonsbarHeight();
    ...
    private class ViewDragCallback extends ViewDragHelper.Callback {
        ...
        public void onViewReleased(View releasedChild, float xvel, float yvel) {
            ...
            mDragHelper.settleCapturedViewAt(left + systemButtonSize, top);
            invalidate();
        }
